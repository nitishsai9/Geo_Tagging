...
class _MyAddPageState extends State<MyAddPage> {
  TextEditingController posInputController;
  ...
  void createData() async {
    ...
    String dt = DateFormat('kk:mm:ss:MMMMd').format(now);
    var fullImageName = '$dt' + '.jpg';
    var fullImageName2 = '$dt' + '.jpg';
